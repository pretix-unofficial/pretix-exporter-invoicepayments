    ...
    def iterate_list(self, form_data):
        ...
        for i in invoice_qs:
            yield [
                ...
                i.tax_rate,
                i.tax_name,
                date_format(i.invoice.date, 'SHORT_DATE_FORMAT'),
        ...
        for p in payment_qs:
            ...
            yield [
                ...
                '',
                '',
                date_format(p.payment_date, 'SHORT_DATE_FORMAT') if p.payment_date else '',
                p.order.code,
        ...
        for p in refund_qs:
            ...
            yield [
                ...
                '',
                '',
                date_format(p.execution_date, 'SHORT_DATE_FORMAT') if p.execution_date else '',
                p.order.code,
                str(pprovs[p.provider]),
                '',
                gci
